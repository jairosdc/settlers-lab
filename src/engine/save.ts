...
export function deserializeGame(raw: string): GameState { const parsed = JSON.parse(raw) as GameState; return recalculateLogistics(recalculateCapacities({ ...createInitialState(), ...parsed, version: SAVE_VERSION })) }
