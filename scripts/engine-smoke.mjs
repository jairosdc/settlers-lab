...
assert.ok(getAdvisorMessages({ ...state, processes: state.processes.map(p=>p.type==='sawmill'?{...p,workers:0,status:'Sin trabajadores'}:p), advisorLevel: 2 }).some(m=>m.includes('Aserradero')), 'asesor detecta proceso parado')
